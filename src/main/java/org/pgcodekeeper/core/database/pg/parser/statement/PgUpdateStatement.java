...
import org.pgcodekeeper.core.database.pg.parser.generated.SQLParser.Update_stmt_for_psqlContext;
...
public final class PgUpdateStatement extends PgParserAbstract {
     ...
     */
    public PgUpdateStatement(Update_stmt_for_psqlContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
