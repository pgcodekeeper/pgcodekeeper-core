...
import org.pgcodekeeper.core.database.pg.parser.generated.SQLParser.Create_fts_parser_statementContext;
 ...
 */
public final class PgCreateFtsParser extends PgParserAbstract {
     ...
     */
    public PgCreateFtsParser(Create_fts_parser_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
