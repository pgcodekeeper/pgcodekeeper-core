...
import org.pgcodekeeper.core.database.pg.parser.generated.SQLParser.Merge_stmt_for_psqlContext;
 ...
 */
public final class PgMergeStatement extends PgParserAbstract {
     ...
     */
    public PgMergeStatement(Merge_stmt_for_psqlContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
