 ...
 * text search objects.
 */
public final class PgAlterFtsStatement extends PgParserAbstract {
     ...
     */
    public PgAlterFtsStatement(Alter_fts_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
