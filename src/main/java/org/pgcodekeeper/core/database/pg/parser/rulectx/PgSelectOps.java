...
public class PgSelectOps {
     ...
     */
    public PgSelectOps(Select_opsContext ops) {
        this.ops = ops;
        this.opsNp = null;
        this.isNp = false;
    }
     ...
     */
    public PgSelectOps(Select_ops_no_parensContext ops) {
        this.opsNp = ops;
        this.ops = null;
        this.isNp = true;
    }
    ...
    public PgSelectOps selectOps(int i) {
        ...
        return ctx == null ? null : new PgSelectOps(ctx);
    }
