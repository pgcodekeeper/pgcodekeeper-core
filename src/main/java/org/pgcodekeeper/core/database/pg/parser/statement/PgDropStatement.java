 ...
 */
public final class PgDropStatement extends PgParserAbstract {
     ...
     */
    public PgDropStatement(Schema_dropContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
    ...
    private void drop(Drop_statementsContext ctx) {
        ...
        for (Schema_qualified_nameContext objName : ctx.if_exist_names_restrict_cascade().names_references()
            ...
            ObjectLocation loc = addObjReference(ids, type, ACTION_DROP);
