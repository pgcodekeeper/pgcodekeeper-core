...
import org.pgcodekeeper.core.database.pg.parser.generated.SQLParser.Create_fts_template_statementContext;
 ...
 */
public final class PgCreateFtsTemplate extends PgParserAbstract {
     ...
     */
    public PgCreateFtsTemplate(Create_fts_template_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
