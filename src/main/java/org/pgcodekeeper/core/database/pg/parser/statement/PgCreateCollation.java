 ...
 */
public final class PgCreateCollation extends PgParserAbstract {
     ...
     */
    public PgCreateCollation(Create_collation_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
