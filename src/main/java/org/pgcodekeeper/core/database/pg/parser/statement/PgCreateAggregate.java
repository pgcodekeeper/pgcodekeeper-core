 ...
 */
public final class PgCreateAggregate extends PgParserAbstract {
     ...
     */
    public PgCreateAggregate(Create_aggregate_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
        ...
        if (params != null) {
            ...
            for (Aggregate_paramContext paramOpt : params) {
                if (paramOpt.SSPACE() != null) {
                    ...
                    db.addAnalysisLauncher(new PgAggregateAnalysisLauncher(aggregate,
