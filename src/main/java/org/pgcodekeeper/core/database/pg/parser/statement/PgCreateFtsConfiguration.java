...
import org.pgcodekeeper.core.database.pg.parser.generated.SQLParser.Create_fts_configuration_statementContext;
 ...
 * operations.
 */
public final class PgCreateFtsConfiguration extends PgParserAbstract {
     ...
     */
    public PgCreateFtsConfiguration(Create_fts_configuration_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
