 ...
 */
public final class PgFtsTemplatesReader extends PgAbstractSearchPathJdbcReader {

    /**
     * Constructs a new PgFtsTemplatesReader.
     *
     * @param loader the JDBC loader base instance
     */
    public PgFtsTemplatesReader(PgJdbcLoader loader) {
        super(loader);
    }
