...
public final class PgAlterOwner extends PgParserAbstract {
     ...
     */
    public PgAlterOwner(Alter_owner_statementContext ctx, PgDatabase db, ISettings settings) {
     ...
     * @param settings  the ISettings object
     */
    public PgAlterOwner(Alter_owner_statementContext ctx, PgDatabase db,
