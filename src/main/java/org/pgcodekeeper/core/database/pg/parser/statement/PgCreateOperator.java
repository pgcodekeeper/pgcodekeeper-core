...
public final class PgCreateOperator extends PgParserAbstract {
     ...
     */
    public PgCreateOperator(Create_operator_statementContext ctx, PgDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
    ...
    public void parseObject() {
        ...
        if (funcCtx != null) {
            ...
            db.addAnalysisLauncher(new PgOperatorAnalysisLauncher(oper, getOperatorFunction(oper, funcIds), fileName));
        }
