...
import org.pgcodekeeper.core.database.ch.parser.generated.CHParser.Create_role_stmtContext;
 ...
 */
public final class ChCreateRole extends ChParserAbstract {
     ...
     */
    public ChCreateRole(Create_role_stmtContext ctx, ChDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
