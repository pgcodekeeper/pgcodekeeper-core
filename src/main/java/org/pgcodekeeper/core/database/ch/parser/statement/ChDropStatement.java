...
import org.pgcodekeeper.core.database.ch.parser.generated.CHParser.Drop_stmtContext;
...
public final class ChDropStatement extends ChParserAbstract {
     ...
     */
    public ChDropStatement(Drop_stmtContext ctx, ChDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
