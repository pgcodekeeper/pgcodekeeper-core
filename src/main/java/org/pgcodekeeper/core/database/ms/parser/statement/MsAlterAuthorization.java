...
public final class MsAlterAuthorization extends MsParserAbstract {
     ...
     */
    public MsAlterAuthorization(Alter_authorizationContext ctx, MsDatabase db, ISettings settings) {
     ...
     * @param settings  parsing configuration settings
     */
    public MsAlterAuthorization(Alter_authorizationContext ctx, MsDatabase db,
