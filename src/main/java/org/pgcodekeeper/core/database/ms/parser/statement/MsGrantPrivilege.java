 ...
 */
public final class MsGrantPrivilege extends MsParserAbstract {
     ...
     */
    public MsGrantPrivilege(Rule_commonContext ctx, MsDatabase db, ISettings settings) {
     ...
     * @param settings  parsing configuration settings
     */
    public MsGrantPrivilege(Rule_commonContext ctx, MsDatabase db, Map<AbstractStatement, StatementOverride> overrides,
                            ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
