 ...
 */
public final class MsDisableTrigger extends MsParserAbstract {
     ...
     */
    public MsDisableTrigger(Enable_disable_triggerContext ctx, MsDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
