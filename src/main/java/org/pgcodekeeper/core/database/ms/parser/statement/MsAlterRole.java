...
import org.pgcodekeeper.core.database.ms.parser.generated.TSQLParser.Alter_db_roleContext;
 ...
 */
public class MsAlterRole extends MsParserAbstract {
     ...
     */
    public MsAlterRole(Alter_db_roleContext ctx, MsDatabase db, ISettings settings) {
        super(db, settings);
        this.ctx = ctx;
    }
