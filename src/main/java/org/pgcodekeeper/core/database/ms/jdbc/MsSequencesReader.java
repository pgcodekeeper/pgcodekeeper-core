 ...
 */
public class MsSequencesReader extends AbstractSearchPathJdbcReader<MsJdbcLoader> implements IMsJdbcReader {
     ...
     */
    public MsSequencesReader(MsJdbcLoader loader) {
        super(loader);
    }
    ...
    protected void processResult(ResultSet res, AbstractSchema schema) throws SQLException, XmlReaderException {
        ...
        s.setDataType(MsJdbcLoader.getMsType(s, res.getString("type_schema"),
