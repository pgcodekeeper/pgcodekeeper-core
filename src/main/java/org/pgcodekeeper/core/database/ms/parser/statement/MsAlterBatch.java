 ...
 */
public final class MsAlterBatch extends MsBatchContextProcessor {
     ...
     */
    public MsAlterBatch(Batch_statement_bodyContext ctx, MsDatabase db, CommonTokenStream stream, ISettings settings) {
