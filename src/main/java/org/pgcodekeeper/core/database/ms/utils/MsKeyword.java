...
public class MsKeyword {

    private static final Map<String, KeywordCategory> KEYWORDS;

    static {
        Map<String, KeywordCategory> keywords = new HashMap<>();
        Vocabulary vocab = TSQLLexer.VOCABULARY;

        ParserUtils.readKeywords(vocab, TSQLLexer.ABORT, TSQLLexer.YEARS, keywords, KeywordCategory.UNRESERVED_KEYWORD);
        ParserUtils.readKeywords(vocab, TSQLLexer.ADD, TSQLLexer.WRITETEXT, keywords, KeywordCategory.RESERVED_KEYWORD);
