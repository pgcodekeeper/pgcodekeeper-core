 ...
 */
public class MsTablesReader extends AbstractSearchPathJdbcReader<MsJdbcLoader> implements IMsJdbcReader {
     ...
     */
    public MsTablesReader(MsJdbcLoader loader) {
        super(loader);
    }
    ...
    protected void processResult(ResultSet res, ISchema schema) throws SQLException, XmlReaderException {
        ...
        List<MsXmlReader> xmlCols = MsXmlReader.readXML(cols);
    ...
    private String getPeriodColName(int colId, List<MsXmlReader> xmlCols) {
        if (colId != 0) {
    ...
    static MsColumn getColumn(MsXmlReader col, MsSchema schema, MsJdbcLoader loader, MsType type) {
        ...
        if (exp == null) {
            ...
            column.setType(MsJdbcLoader.getMsType(column, col.getString("st"), col.getString("type"),
