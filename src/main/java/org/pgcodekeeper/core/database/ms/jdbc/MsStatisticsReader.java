 ...
 */
public final class MsStatisticsReader extends AbstractSearchPathJdbcReader<MsJdbcLoader> implements IMsJdbcReader {
     ...
     */
    public MsStatisticsReader(MsJdbcLoader loader) {
        super(loader);
    }
