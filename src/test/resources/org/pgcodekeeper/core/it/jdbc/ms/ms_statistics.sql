...
CREATE TABLE dbo.PartitionTable (
    [col1] [datetime2]
--     col1 datetime2(0) PRIMARY KEY --broken case
     NOT NULL,
    [col2] [char] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL)
    ON myRangePS1 (col1) ;
GO

-- something wrong with partition function
--ALTER TABLE [dbo].[PartitionTable]
--	ADD CONSTRAINT [PK__Partitio__357D0D3E9BAF9BB1] PRIMARY KEY CLUSTERED  ([col1]) ON [myRangePS1]
--GO
