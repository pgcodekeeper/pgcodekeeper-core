...
ALTER TABLE public.t1 OWNER TO test;

ALTER TABLE public.t2 OWNER TO test;

ALTER FUNCTION public.f1(p1 text, p2 integer) OWNER TO test;

ALTER FUNCTION public.f2() OWNER TO test;

ALTER VIEW public.v1 OWNER TO test;

ALTER VIEW public.v2 OWNER TO test;

ALTER VIEW public.test OWNER TO test;
