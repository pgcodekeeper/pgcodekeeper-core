...
CREATE TABLE t_empty_tuple (x Tuple()) ENGINE = MergeTree ORDER BY tuple();
CREATE TABLE t_empty_tuple2 (x Tuple(), y Tuple(Int32)) ENGINE = MergeTree ORDER BY tuple();
ALTER TABLE test_table ALTER COLUMN IF EXISTS col1 TYPE Int32;
ALTER TABLE test_table ALTER COLUMN IF EXISTS col1 TYPE String DEFAULT 'test';
ALTER TABLE test_table ALTER COLUMN IF EXISTS col1 TYPE Int32 CODEC(ZSTD) TTL d + INTERVAL 1 DAY;
ALTER TABLE test_table ALTER COLUMN IF EXISTS col1 TYPE Int32 SETTINGS allow_nullable_key = 1;
ALTER TABLE test_table ADD CONSTRAINT IF NOT EXISTS c1 CHECK a > 0;
ALTER TABLE test_table ADD CONSTRAINT IF NOT EXISTS c1 ASSUME b > 10;
CREATE TABLE t_constraint_new (a Int32, b Int32, CONSTRAINT c1 CHECK a > 0, CONSTRAINT c2 ASSUME b > 10) ENGINE = MergeTree ORDER BY a;
ALTER TABLE test_table FORGET PARTITION '2024-01';
ALTER TABLE test_table FORGET PARTITION ID '202401';
ALTER TABLE test_table REWRITE PARTS;
ALTER TABLE test_table REWRITE PARTS IN PARTITION '2024-01';
ALTER TABLE test_table REWRITE PARTS IN PARTITION ID '202401';
ALTER TABLE test_table MODIFY COLUMN col1 Int32 SETTINGS max_compress_block_size = 65536;
ALTER TABLE test_table MODIFY COLUMN col1 Int32 CODEC(ZSTD) SETTINGS max_compress_block_size = 65536 FIRST;
