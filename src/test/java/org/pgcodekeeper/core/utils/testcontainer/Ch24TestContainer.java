...
final class Ch24TestContainer implements ITestContainer {
    ...
    public String getDraftUrl() {
        return "jdbc:clickhouse://localhost:%s/default" + "?user=%s&password=%s".formatted(TEST_USER, TEST_PASSWORD);
    }

    @Override
    public GenericContainer<?> getTestContainer() {
        return new ClickHouseContainer("clickhouse/clickhouse-server:24.12.3")
